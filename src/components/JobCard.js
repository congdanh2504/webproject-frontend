                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="row form-row">
                            <InputTag defaultValue={job.title} type='text' name="title" title="Title" placeholder="Title" onChange={changeInput} Image required='true' />
                            ...
                            <InputTag defaultValue={job.detail} type='text' title="Detail location" name="detail" placeholder="Detail location" onChange={changeInput} required='true' />
                            <div class="form-group">
                              <label>Province <span class="text-danger">*</span></label>
                              <Select placeholder="Province" onChange={changeProvince} options={provinceOptions} />
                            </div>
                            <InputTag defaultValue={job.nameJob} type='text' title="Carrier" name="nameJob" placeholder="Input the name of career!" onChange={changeInput} required='true' />
                            <InputTag defaultValue={job.duration} type='date' title="Duration" name="duration" onChange={changeInput} required='true' />
                            <InputTag defaultValue={job.salary} type='number' title="Salary (USD)" name="salary" onChange={changeInput} required='true' />
                          </div>
                          <div class="row form-row">
                            <TextAreaTag
