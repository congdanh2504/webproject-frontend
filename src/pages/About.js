          ...
          <div class="row">
            <div class="col-12">
              ...
              <div class="about-us-top-content text-center">
                ...
                <p>
                  Jobhub was created to help employers, businesses, and
                  employees connect. With Jobhub, finding jobs and hiring
                  workers will be a lot easier. Furthermore, you can gain a lot
                  of experience from other members' shared blogs.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="about-promo-single-item">
                ...
                <p>
                  {" "}
                  diverse and abundant job pool from a variety of reputable
                  companies and employers will help you avoid taking unnecessary
                  risks.
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="about-promo-single-item">
                ...
                <h6>Easy and Fast</h6>
                <p>
                  You'll have no trouble finding the right job. If you are the
                  employer, on the other hand, hire someone.
                </p>
              </div>
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="about-promo-single-item">
                ...
                <p>
                  We are always available to help you if you have a problem.
                </p>
              </div>
            </div>
          </div>
