              ...
              <div class="sort-by">
                ...
                <span class="sortby-fliter">
                  <select class="select" onChange={sortChange}>
                    ...
                    <option class="sorting" value="Rating">
                      Rating
                    </option>
                    <option class="sorting" value="Latest">
                      Latest
                    </option>
                    <option class="sorting" value="Salary">
                      Salary
                    </option>
                  </select>
                </span>
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-md-12 col-lg-4 col-xl-3 theiaStickySidebar">
              {getUser() && getUser().type == "Employer" && (
                <Link to="jobs/add-job" className="add-new-btn">
                  Add job
                </Link>
              )}
              {/* <!-- Search Filter --> */}
